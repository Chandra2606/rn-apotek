...
export default function FormEdit({route}) {
  ...
  const [jenisObat, setJenis] = useState('');
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        setNamaObat(json.namaobat);
        setJenis(json.jenisobat);
        setStok(json.stokobat);
        setHargaBeli(json.hargabeli);
        setHargaJual(json.hargajual);
      } catch (error) {
  ...
  const submitForm = () => {
    ...
    fetch(`${apiUrl}obat/${kodeobat}`, {
      ...
      .then(async response => {
        ...
        Alert.alert('Success', 'Data obat berhasil DiUpdate', [
          {
            text: 'ok',
            onPress: () =>
              navigation.navigate('DetailObat', {kodeobat: kodeobat}),
          },
        ]);
      })
      .catch(error => {
  ...
  return (
    <ScrollView
      ...
      <Input
        ...
        errorMessage={validationErrors.kodeobat}
      />
      ...
      <Input
        ...
        errorMessage={validationErrors.namaobat}
      />
      <Input
        ...
        inputStyle={styles.inputText}
        // leftIcon={<Icon name="user" size={24} color="black" />}
        errorMessage={validationErrors.jenisobat}
      />

      <Input
        placeholder="Stok"
        value={stok !== null ? stok.toString() : ''}
        onChangeText={setStok}
        // leftIcon={<Icon name="home" size={24} color="black" />}
        placeholderTextColor="#888"
        inputContainerStyle={styles.inputContainer}
        inputStyle={styles.inputText}
        errorMessage={validationErrors.stokobat}
        keyboardType="number-pad"
      />
      <Input
        placeholder="Harga Beli"
        value={hargaBeli !== null ? hargaBeli.toString() : ''}
        onChangeText={setHargaBeli}
        // leftIcon={<Icon name="map-marker-alt" size={24} color="black" />}
        placeholderTextColor="#888"
        inputContainerStyle={styles.inputContainer}
        inputStyle={styles.inputText}
        errorMessage={validationErrors.hargabeli}
        keyboardType="number-pad"
      />

      <Input
        placeholder="Harga Jual"
        value={hargaJual !== null ? hargaJual.toString() : ''}
        onChangeText={setHargaJual}
        // leftIcon={<Icon name="phone" size={24} color="black" />}
        placeholderTextColor="#888"
        inputContainerStyle={styles.inputContainer}
        inputStyle={styles.inputText}
        errorMessage={validationErrors.hargajual}
        keyboardType="number-pad"
      />
